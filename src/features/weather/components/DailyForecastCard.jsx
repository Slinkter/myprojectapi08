 ...
 * - Wrapped in React.memo to prevent unnecessary re-renders in lists.
 * - Uses content-visibility for rendering optimization.
 *
...
const DailyForecastCard = memo(({ dayName, iconCode, minTemp, maxTemp }) => {
    return (
        <div className="forecast-card flex flex-col items-center justify-center p-4 bg-white rounded-2xl border border-gray-100 shadow-sm transition-transform hover:-translate-y-1">
